...
namespace cCoder.Core.Objects.Workflow.Activities.DMS
{
    ...
    { 
        ...
        public override async Task Execute()
        {
            ...
            var response = await remoteApi.GetAsync($"DMS/{RemotePath}", HttpCompletionOption.ResponseHeadersRead);
            ...
            using var remoteFolderStream = await response.Content.ReadAsStreamAsync();
