...
{
    private ICoreDataContext Core { get; }
    ...
    private async Task<bool> ProcessEmail(SmtpClient client, QueuedEmail email)
    {
    ...
    private bool ValidateCertChain(object s, X509Certificate certificate, X509Chain chain, SslPolicyErrors sslPolicyErrors)
    {
