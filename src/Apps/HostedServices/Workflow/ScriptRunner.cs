...
public class ScriptRunner : IScriptRunner
{
    ...
    private static void SafelyLoadAssembly(LogEvent log, List<Assembly> loadedAlready, string assemblyPath)
    {
        try
        {
    ...
    public Task Run(string code, string[] imports, object args, Action<WorkflowLogLevel, string> log) => Run<bool>(code + ";return true;", imports, args, log);
}