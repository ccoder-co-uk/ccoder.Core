...
public class FlowRunner
{
    ...
    public async Task Run(WorkflowRequest msg)
    {
        ...
        try
        {
            ...
            Task log(WorkflowLogLevel level, string message)
            {
                return Log(level, message, msg.InstanceId);
            }

            FlowInstance instance = await FlowHelper.GetInstance(msg.InstanceId, msg.Api, msg.AuthToken, log);
