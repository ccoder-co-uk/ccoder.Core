...
public sealed class FlowInstance
{
    ...
    private FlowInstance(LogEvent log)
    {
    ...
    public FlowInstance(FlowInstanceData instanceData, LogEvent log) : this(log)
    {
        ...
        cCoder.Core.Objects.Dtos.Workflow.WorkflowContext dtoContext = JsonConvert.DeserializeObject<cCoder.Core.Objects.Dtos.Workflow.WorkflowContext>(Encoding.UTF8.GetString(instanceData.ContextJson), ObjectExtensions.GetJSONSettings());
