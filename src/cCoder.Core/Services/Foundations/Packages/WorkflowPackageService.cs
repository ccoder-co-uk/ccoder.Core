...
internal sealed partial class WorkflowPackageService(
    IWorkflowPackageBroker workflowPackageBroker) : IWorkflowPackageService
{
    public ValueTask ImportPackageAsync(int appId, Package package) =>
        TryCatch(operation: () =>
        {
            ...
            return workflowPackageBroker.ImportPackageAsync(
                appId: appId,
    ...
    public Package ExportPackage(int appId, string packageName) =>
        TryCatch(operation: () =>
        {
            ...
            return ToLocalPackage(package: workflowPackageBroker.ExportPackage(
                appId: appId,
