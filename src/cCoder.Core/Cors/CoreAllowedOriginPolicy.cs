...
public static class CoreAllowedOriginPolicy
{
    private static readonly StringComparer Comparer = StringComparer.OrdinalIgnoreCase;

    public static CoreAllowedOriginSnapshot CreateSnapshot(IEnumerable<string> configuredOrigins)
    {
    ...
    public static bool IsAllowed(string origin, CoreAllowedOriginSnapshot snapshot)
    {
