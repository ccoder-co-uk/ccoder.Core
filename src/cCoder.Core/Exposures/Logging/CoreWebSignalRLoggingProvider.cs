...
namespace cCoder.Core.Exposures.Logging;

internal sealed class CoreWebSignalRLoggingProvider(IServiceProvider serviceProvider) : ILoggerProvider
{
    public ILogger CreateLogger(string categoryName) =>
        new CoreWebSignalRLogger(
...
internal sealed class CoreWebSignalRLogger(
    ...
    string categoryName) : ILogger
{
    ...
    private static bool ShouldIgnoreCategory(string categoryName) =>
        ...
        || categoryName == typeof(CoreWebSignalRLogger).FullName;
}
