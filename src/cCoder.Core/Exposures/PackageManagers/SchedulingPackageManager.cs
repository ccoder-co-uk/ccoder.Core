...
using PackagingManager = cCoder.Packaging.Exposures.PackageManagers.ISchedulingPackageManager;

namespace cCoder.Core.Exposures.PackageManagers;

internal sealed class SchedulingPackageManager(
    ISchedulingPackageProcessingService processingService)
    : PackagingManager
{
