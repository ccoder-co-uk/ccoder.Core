...
using PackagingManager = cCoder.Packaging.Exposures.PackageManagers.IContentManagementPackageManager;

namespace cCoder.Core.Exposures.PackageManagers;

internal sealed class ContentManagementPackageManager(
    IContentManagementPackageProcessingService processingService)
    : PackagingManager
{
