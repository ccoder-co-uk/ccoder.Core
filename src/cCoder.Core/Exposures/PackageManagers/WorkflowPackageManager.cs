...
using PackagingManager = cCoder.Packaging.Exposures.PackageManagers.IWorkflowPackageManager;

namespace cCoder.Core.Exposures.PackageManagers;

internal sealed class WorkflowPackageManager(
    IWorkflowPackageProcessingService processingService)
    : PackagingManager
{
