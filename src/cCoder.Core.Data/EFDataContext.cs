...
namespace cCoder.Core.Data
{
        ...
        where TRole : class
    {
        ...
        {
            var result = base.Update(entity).Entity;
            _ = await SaveChangesAsync();
            return result;
        }
        ...
        {
            var results = items.Select(i => base.Update(i).Entity).ToArray();
            _ = await SaveChangesAsync();
            return results;
        }
        ...
        async Task<int> SaveChangesInternal()
        {
        ...
        async Task RaiseEvents(object[] allAdds, object[] allUpdates, object[] allDeletes)
        {
