...
namespace cCoder.Core
{
    ...
    {
        readonly IDictionary<string, IDictionary<string, string>> metaSerialized;
        readonly IEnumerable<MetadataContainerSet> typeSet;
        readonly ICommonObjectCache resourceCache;
