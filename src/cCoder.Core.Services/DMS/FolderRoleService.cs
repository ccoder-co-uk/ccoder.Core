...
public class FolderRoleService : CoreService<FolderRole>, ICoreService<FolderRole>
{
    ...
    public override Task<FolderRole> AddAsync(FolderRole entity)
    {
        ...
        Func<Folder, Role, bool> UserHasPermission = (Folder folder, Role role) => folder.UserCan(User, "folderrole_create");
    ...
    private (Role role, Folder folder) GetFolderAndRole(FolderRole entity)
     => (
