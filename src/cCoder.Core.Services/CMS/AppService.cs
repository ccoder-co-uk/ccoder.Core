...
namespace cCoder.Core.Services.CMS
{
    public class AppService : CoreService<App>, IAppService
    {
        ...
        public override async Task<App> AddAsync(App inputApp)
        {
            ...
            {
                var newApp = new App().UpdateFrom(inputApp, true);
        ...
        public IEnumerable<Package> Export(int appId, string[] packages)
        {
            ...
            var serializerSettings = ObjectExtensions.GetJSONSettings();
        ...
        private static Package ExportPageRoles(List<PageRoleInfo> pageRoles, JsonSerializerSettings serializerSettings)
        {
        ...
        private Package ExportWorkflows(int appId, JsonSerializerSettings serializerSettings)
        {
        ...
        private Package ExportCalendarEvents(int appId, JsonSerializerSettings serializerSettings)
        {
        ...
        private Package ExportBusinessProcesses(int appId, JsonSerializerSettings serializerSettings)
        {
            return new Package("BusinessProcesses")
            {
                Items = new[]
                {
                    new PackageItem()
        ...
        private Package ExportCalendars(int appId, JsonSerializerSettings serializerSettings)
        {
        ...
        private Package ExportResources(int appId, JsonSerializerSettings serializerSettings)
        {
        ...
        private Package ExportScripts(int appId, JsonSerializerSettings serializerSettings)
        {
        ...
        private Package ExportComponents(int appId, JsonSerializerSettings serializerSettings)
        {
        ...
        private Package ExportTemplates(int appId, JsonSerializerSettings serializerSettings)
        {
        ...
        private Package ExportLayouts(int appId, JsonSerializerSettings serializerSettings)
        {
        ...
        private static Package ExportFolderRoles(Folder[] folderData, JsonSerializerSettings serializerSettings)
        {
        ...
        private static Package ExportRoles(Role[] roleData, JsonSerializerSettings serializerSettings)
        {
