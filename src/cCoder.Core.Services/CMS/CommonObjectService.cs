...
public class CommonObjectService : CoreService<CommonObject>, ICommonObjectService
{
    ...
    {
        static bool matchesOnCultureNameAndKey(CommonObject dbc, CommonObject entry)
        {
            return dbc.Culture == entry.Culture && dbc.Name == entry.Name && dbc.Key == entry.Key;
        }
    ...
    public override async Task<CommonObject> UpdateAsync(CommonObject entity)
    {
        ...
        if (entity.Type.ToLowerInvariant() == "core/component")
        {
            ...
            CommonObject latestSetObject = Cache.LatestSet.First(r => r.Name.ToLowerInvariant() == entity.Name.ToLowerInvariant() && r.Type == "Core/Component");
        ...
        else if (entity.Type.ToLowerInvariant() == "core/resource")
        {
            ...
            CommonObject latestSetObject = Cache.LatestSet.First(r => r.Name.ToLowerInvariant() == entity.Name.ToLowerInvariant()
        ...
        {
            CommonObject latestSetObject = Cache.LatestSet.First(r => r.Name.ToLowerInvariant() == entity.Name.ToLowerInvariant() && r.Type == "Core/Script");
            latestSetObject.UpdateFrom(entity);
