...
public class CsvFormatter : TextOutputFormatter
{
    ...
    private static (string delimiter, string quotes, string culture) ExtractValues(OutputFormatterWriteContext context)
    {
        if (context == null)
    ...
    private static IEnumerable<Resource> GetResources(OutputFormatterWriteContext context, string culture)
    {
