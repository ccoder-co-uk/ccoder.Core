...
namespace cCoder.Core.Api.Hubs
{
    public abstract class CoreHub : Hub
    {
        ...
        static readonly IDictionary<string, ICollection<HistoryItem>> History = new Dictionary<string, ICollection<HistoryItem>>();
        static readonly IDictionary<string, int> UserCounts = new Dictionary<string, int>();
