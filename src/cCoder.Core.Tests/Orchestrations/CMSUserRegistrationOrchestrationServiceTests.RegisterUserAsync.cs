...
{
    [Fact]
    public async Task ShouldAddUserAndSkipEmailWhenConfirmationEmailDisabledForRegisterUserAsync()
    {
        ...
        User result = await orchestrationService.RegisterUserAsync(user, app.Id, "token", false);
