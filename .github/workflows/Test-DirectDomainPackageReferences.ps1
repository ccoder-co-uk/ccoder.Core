...
$expectedReferences = [ordered]@{
    ...
    "cCoder.ContentManagement" = "2026.9.9.913"
    "cCoder.Data" = "2026.9.9.951"
    "cCoder.DocumentManagement" = "2026.9.9.1012"
...
$expectedConsumerReferences = @(
    ...
    @{ Project = "src/cCoder.Core.Tests/cCoder.Core.Tests.csproj"; Package = "cCoder.ContentManagement"; Version = "2026.9.9.913" },
